...
describe('RentalContract Management Component', () => {
  let comp: RentalContractComponent;
  let fixture: ComponentFixture<RentalContractComponent>;
  let service: RentalContractService;

  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'rental-contract', component: RentalContractComponent }]), HttpClientTestingModule],
      ...
      .overrideTemplate(RentalContractComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.rentalContracts?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
