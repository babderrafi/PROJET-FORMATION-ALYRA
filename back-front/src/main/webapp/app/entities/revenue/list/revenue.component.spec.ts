...
describe('Revenue Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'revenue', component: RevenueComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.revenues?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
